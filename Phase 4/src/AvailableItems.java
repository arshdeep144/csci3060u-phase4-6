/*
    This program creates a file holding information on the ongoing auctions. The file will store auction information on
    the item name, seller username, bidder username, minimum bid, and number of days remaining.
